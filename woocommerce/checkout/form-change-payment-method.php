...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo wp_kses( apply_filters( 'woocommerce_change_payment_button_html', '<p class="btn-red"><input type="submit" class="button alt" id="place_order" value="' . esc_attr( $pay_order_button_text ) . '" data-value="' . esc_attr( $pay_order_button_text ) . '" /></p>' ), array( 'input' => array( 'type' => array(), 'class' => array(), 'id' => array(), 'value' => array(), 'data-value' => array() ) ) ); ?>
