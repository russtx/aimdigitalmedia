...
<div class="package-body">
  <?php if(have_rows('product_details_list')): ?>
    <ul class="list-group row">
      <?php while(have_rows('product_details_list')) : the_row(); ?>
	...
	<?php else : ?>
      ...
      <div class="variations">
        ...
        <div class="form-group">
          <label for="<?php echo esc_attr(sanitize_title($attribute_name)); ?>" class="control-label"><?php echo esc_html(wc_attribute_label($attribute_name)); ?></label>
          <?php
