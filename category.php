<?php get_header(); ?>
    <div class="main">
      <div class="container">
          ...
          <div class="col-sm-8 mt40">
            <?php if(have_posts()) : while(have_posts()) : the_post(); ?>
              <div class="blog-post">
                ...
                <h3 class="read-more"><a href="#<?php echo $post_slug; ?>" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="<?php echo post_slug; ?>">Read More &gt;</a></h3>
        ...
        <?php if(get_field('show_featured_section', 19)): ?>
